...
차량선택시 상세보기로 이동
 */
public class HomeGridAdapter_old extends BaseAdapter {
    private Context context;
    private ArrayList<ProductBean> data;
    private ImageView imageView;
    private RequestManager glideMang;
    private int pos = 0;
    public HomeGridAdapter_old(Context context, ArrayList<ProductBean> data, RequestManager mGlideRequestManager){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            Picasso.get().load("file:///"+context.getFilesDir()+"/"+imgStr).into(viewHolder.productImage);
